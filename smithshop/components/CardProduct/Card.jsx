...
import { container, item } from '../../utility/motionVariants'
...
function Item({ id, img, name , price }) {
    ...
    return (
        ...
        >
            <Link href={id} className='absolute top-0 left-0 right-0 bottom-0' underline="none">
                <a>
                        <img src={img} className='rounded-lg object-cover' height={250} width={300} />
    ...
    return (
        ...
        >
            <div className="flex items-center gap-2 justify-center font-bold text-white w-full h-11 bg-gradient-to-r from-rose-500 to-rose-400 rounded-full" >
                <img className='object-cover' src={bag} width={22} height={22} />
